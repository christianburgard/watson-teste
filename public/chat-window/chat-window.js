//BEGIN OF MINIFIED SOCKET.IO FOR DRUPAL INCLUDE
...
//END OF MINIFIED SOCKET.IO FOR DRUPAL INCLUDE
var socket = io();
...
function toggleChatWindow(){
      ...
      jQuery(document).ready(function() {
          jQuery("#ChatContent").load("http://chatsenai-teste.mybluemix.net/chat-window/chat-window.html"); 
          javascriptCheck();
...
var Api = (function() {
  var requestPayload;
  var responsePayload;
  var messageEndpoint = 'http://chatsenai-teste.mybluemix.net/api/message';
...
//    input.addEventListener('input', adjustInput);
  ...
  function getChatLog() {
    ...
    http.open('GET', "http://chatsenai-teste.mybluemix.net/api/message?chatlog=true", true);
